...
<input onChange={handleSchoolName} className="input"
value={schoolname} type="text" />

<label className="label">Street Name</label>
<input onChange={handleStreet} className="input"
...
<input onChange={handleEthnicity} className="input"
value={ethnicity} type="text" />
